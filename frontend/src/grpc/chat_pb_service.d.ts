...
type ChatServiceSubscribe = {
  ...
  readonly requestType: typeof chat_pb.SubscribeRequest;
  readonly responseType: typeof chat_pb.StreamMessage;
};
...
export class ChatServiceClient {
  ...
  subscribe(requestMessage: chat_pb.SubscribeRequest, metadata?: grpc.Metadata): ResponseStream<chat_pb.StreamMessage>;
}
